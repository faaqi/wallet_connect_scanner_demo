## Send Crypto UI package

Send Crypto UI package containing a general design system.
...
│   │       ├── colors
│   │       ├── icons
│   │       │      ├── send_crypto_icons_dark.dart
│   │       │      ├── send_crypto_icons_light.dart
│   │       │      └── send_crypto_icons.dart 
│   │       ├── spacing
│   │       ├── theme
│   │       ├── typography
│   │       └── widgets
│   │             ├── send_crypto_app_bar.dart
│   │             ├── send_crypto_outlined_button.dart
│   │             └── send_crypto_text_field.dart 
│   ├── send_crypto_ui.dart
│   ├── .gitignore
...
1) Inside `send_crypto_icons.dart`:
...
```
2) In `send_crypto_icons_light.dart` add the icon with its color respectively of the theme. 
...
3) In `send_crypto_icons_dark.dart` add the icon with its color respectively of the theme. 
